    ...
    views:{
        ...
        Footer:{
            ...
            TermsOfUse:{
                ...
                tit_17_p2:' RM 1902 EASEY COMM BLDG 253-261 HENNESSY RD WANCHAI HK',           
            },
            Warranty:{
                    title:'Warranty',
        ...
        shop:{
            ...
            review:{
                ...
                Submit:'Submit',
                rules:{
                    serviceScore:'Star is required',
                    comment:'Review is required',
                },
                message:'Thank you for your review. It has been submitted to the webmaster for approval.'
            },
            Search:'No result',
            shoppingCart:{
                p1:'Free Shipping',
        ...
        Support:{
            ...
            faq:{
                ...
                tit_1:'How to use Rugged-Phone underwater camera / video mode?',
                msg_1_1:"Boot into the main interface, drop down the status bar at the top of the phone to find the underwater camera menu, and click the underwater camera to enter the underwater shooting mode;",
                msg_1_2:"Underwater mode disables the touch screen and the three buttons at the bottom of the screen. All menus of this interface are the default menu of the camera mode. If you need to adjust, please exit the underwater shooting mode and adjust it in the normal mode.",
                msg_1_3:"Use the Volume Up button to take a photo or start/stop a video;",
                msg_1_4: "Click the volume down button to switch between photos and videos.",
                msg_1_5:'Press and hold the volume down button for 1-3 seconds and release the button to switch between the front and rear cameras.',
                msg_1_6:'Press the side power button to turn off the monitor and exit the underwater camera.',

                tit_2:'How to use Phone custom buttons?',
                msg_2_1:'This button allows you to open a specific application when you short press , long press or double-click the "Programmable" button.',
                msg_2_2:'Boot into the setup menu, scroll down to “Smart” and open the option;',
                msg_2_3:'Click short press, long press or double click to enter the setting shortcut operation to open the menu list; (enable recording, flashlight, screen capture, underwater camera, etc.)',
                msg_2_4:'Click short press, long press or double click to enter the settings to open the application, set to open any application in the phone;',
                msg_2_5:'Note: Only one option can be used at a time.',

                tit_3:'What does Non-incendive: Class 1 Division 2, Grade A-D, T4 mean?',
                msg_3_1:'1. Zone 2 (or Div 2) is a place in which an explosive atmosphere is not likely to occur in normal operation but, if it does occur, will persist for a short period only (< 10hours/year).',
                msg_3_2:'2. T4 references the maximum temperature the phone will reach. This phone is rated T4 meaning the phone temperature will not exceed 135° C.',
                msg_3_3:'3. Group A-D refers to hazardous gas types.',
                msg_3_4:'4. TAMB refers to the upper and lower ambient temperatures the phone is approved for use in and remain non-incendive rated. For Blackview Rugged Phone, that range is -10°C to +55°C',

                tit_4:'What is the IP and MIL SPEC rating for Blackview Rugged Phone?',
                msg_4_1:'IP stands for "Ingress Protection". Blackview Rugged Phone is rated as IP68. The "6" in this rating refers to the dust rating. This phone is rated as "Dust Tight" meaning complete protection against dust intrusion as long as all port covers are properly closed.',
                msg_4_2:"The '8' in the rating refers to the phone's ability to be submerged in water. The Blackview Phone can be submerged in up to 1.5m of water for 30 minutes as long as all port covers are properly closed.",
                msg_4_3:'The MIL-SPEC rating for Blackview Rugged Phone is MIL SPEC 810G making the Blackview Rugged Phone drop proof to "6" , dust proof (when all port covers are properly closed), and vibration proof (Category 4 – Truck/Trailer – Secured Cargo ).',

                tit_5:'What is the hazardous area classification for the Blackview Phone?',
                msg_5_1:'Non-Incendive: Class 1 Division 2, Grade A-D, T4.',
                msg_5_2:'(Do not charge or connect or remove anything to the phone while in a hazardous areas.)',
                
                tit_6:'Where can I buy Blackview Phone?',
                msg_6_1:'Blackview Phone can be purchased through this Website Store, AliExpress Store, Amazon Store etc.',

                tit_7:'How do I resolve when Poor Sound Quality is experienced?',
                msg_7_1:'There are a number of contributing factors which can affect the audio performance of your device:',
                msg_7_2:'The most common cause of poor sound quality is water in the microphone or speaker.',
                msg_7_3:'If the handset has been subject to immersion in water then the microphone and speaker may need to dry out to resume normal functionality.',
                msg_7_4:'You, or the other person you are speaking with, may be in an area of poor signal. Try moving to a different area.',
                msg_7_5:'You may have dirt / debris covering the microphone or speaker. If so, clean your device.',

                tit_8:'What should I do when experiencing reception / signal issues?',
                msg_8_1:'Poor quality of calls:',
                msg_8_2:'Please check if the volume of the device is adjusted to an acceptable comfortable level.',
                msg_8_3:'When the device is used in areas with poor signal, e.g. near high buildings or in basements, the call quality may be adversely affected.',
                msg_8_4:'When this device is used in a high call intensity period, like rush hour, call failure / poor call quality may be caused by network congestion.',
                msg_8_5:'Note:',
                msg_8_6:'If you are in an area of poor reception/signal, you may experience shorter standby time than usual. This is because your device is regularly searching for a better signal and therefore consuming battery.',

                tit_9:'What do I need to do if “Enter PUK code” is displayed?',
                msg_9_1:'Following three consecutive failures to input the correct SIM card PIN code, the PIN code will be blocked and the request for the PUK code will be displayed.',
                msg_9_2:'Before attempting to input the PUK code ensure that you have the correct code provided by Network provider.',
                msg_9_3:'After ten unsuccessful attempts to input the PUK code, the SIM card will be permanently disabled.',
                msg_9_4:'Once the SIM card is permanently disabled you will need to contact relevant body to purchase a New SIM card.',

                tit_10:'What do I do if “Emergency Call only” is displayed on your Home screen?',
                msg_10_1:'This will be displayed if there are issues with the SIM card or problem with your cellular account.',
                msg_10_2:'Additionally if you are in an area not covered by your Network Provider.',

                tit_11:'What should I do if the device displays message "No Service"?',
                msg_11_1:'This may be displayed if you are in an area that is not covered by your Network provider, or if you are in an area of poor reception for example an enclosed area.',
                msg_11_2:'No service will be displayed on your screen until the situation is resolved by relocating to an area of service.',
                msg_11_3:'If this problem persists when in a known good service location, contact your Network provider to ensure there are no restrictions on service or your SIM services.',

                tit_12:'What does the Message "Insert SIM card" indicate?',
                msg_12_1:'This message may appear if your device does not recognize the SIM card.',
                msg_12_2:'Make sure that you have correctly inserted the SIM card.',
                msg_12_3:'Clean the metal side of the SIM card with a dry cloth.',
                msg_12_4:'If the SIM card still not being recognized, please contact your Network provider to ensure the SIM card has been enabled or to check if they have any further instructions.',

                tit_13:'How can I back up data to an external storage device?',
                msg_13_1:'To transfer files from your phone to PC / Mac:',
                msg_13_2:'Connect your Blackview Phone to your PC / Mac via USB cable.',
                msg_13_3:'On the Blackview Phone notification tray, tap the "Use USB to" notification and select "Transfer files".',
                msg_13_4:'The Blackview Phone will now be visible on the PC / Mac.',
                msg_13_5:'Open the Blackview Phone via the PC / Mac to explore files.',
                msg_13_6:'Copy over anything to the PC / Mac that you wish to back-up.',
                msg_13_7:'Note: Alternatively, backup to a MicroSD™ card by inserting one into the Blackview Phone. Copy files to it using your chosen file explorer app.',

                tit_14:'How do I Clear the cache and browser History?',
                msg_14_1:'Launch the Chrome app.',
                msg_14_2:'Click the menu icon in the top right (three vertical dots).',
                msg_14_3:'Click "Settings".',
                msg_14_4:'Click "Privacy".',
                msg_14_5:'Scroll down and tap "Clear browsing data".',
                msg_14_6:'Select the time range you wish to clear.',
                msg_14_7:'Select what data (Browsing history, Cookies and site data, and Cached images and files) you wish to clear.',
                msg_14_8:'Under "Advanced" you have further options to clear saved passwords, form data, and more.',
                msg_14_9:'Click "Clear data".',

                tit_15:'How can I transfer data to another device via Bluetooth (for example an image)?',
                msg_15_1:'Locate the file that you wish to share on your device.',
                msg_15_2:'If you only want to send one item, for example a photograph, tap on it and then tap the share icon.',
                msg_15_3:'Select the Bluetooth sharing option.',
                msg_15_4:'Choose which Bluetooth enabled device to send the file to.',
                msg_15_5:'Accept the incoming file on the target device.',

                tit_16:'How do I customize the Notifications, sound and vibration for incoming messages?',
                msg_16_1:'Launch the Messaging app.',
                msg_16_2:'Within the app bring up the Settings menu',
                msg_16_3:'Scroll down to "Notifications" section.',
                msg_16_4:'Select the "Sound" menu to select the desired sound.',
                msg_16_5:'Next to "Vibrate" tick to enable/disable vibration for incoming messages.',

                tit_17:'How do I know there is a device update available, how do I check I have the latest SW?',
                msg_17_1:'NOTE: When a new Firmware/Software is available, notifications are sent out to all Blackview Phone devices.',
                msg_17_2:'On the home screen an Icon will show in the notification panel. When the icon appears you can drag down the notification panel and select.',
                msg_17_3:'To manually update:',
                msg_17_4:'Go to settings menu.',
                msg_17_5:'Scroll to the bottom of this screen, and select "System".',
                msg_17_6:'Select the "System update" option.',
                msg_17_7:'Select the "Check for update" option and follow the prompts.',
                msg_17_8:'Note: The device should be fully charged prior to updating the system.',

                tit_18:'How do I resolve when Poor Sound Quality is experienced following immersion in water?',
                msg_18_1:'To reset the device, keep the power button pressed for about 10 seconds / until vibration is felt.',
                msg_18_2:'Device will now power on, perform and charge as expected.',

                tit_19:'How do I improve battery life?',
                msg_19_1:'Applications (such as Skype™) that frequently utilize VOIP (Voice over IP) and other data via Wi-Fi or 3G/4G can significantly reduce battery life. Disable any such applications when maximum battery life is desired.',
                msg_19_2:'Set the display sleep to a start after 15 seconds of inactivity. To change the display timeout settings: from the home screen tap > Settings > Display >Advanced > Sleep > select a shorter delay time.',
                msg_19_3:"Reduce the intensity of the display. To change the display's brightness, Settings > Display > Brightness level > drag the control bar to the left for a dimmer display or right for a brighter display.",
                msg_19_4:'Disable Wi-Fi when not using it. To disable Wi-Fi: Settings > Network and Internet > tap the on/off button so it is no longer green.',
                msg_19_5:'Make sure your phone has the latest software updates. To check for the latest updates: Settings > System > System update > Check for update.',
                msg_19_6:'Stop any unnecessary programs you installed from running in the background by: Settings > Apps and notifications > See all apps > select and disable any apps that you do not need.',
                msg_19_7:'Note! Only stop applications that you have installed. Stopping other pre-installed applications may result in poor phone performance or errors.',

                tit_20:'How do I find my IMEI Number?',
                msg_20_1:"This can be found on the outside of the box that you received your phone in and makes up part of the Approval's label.",
                msg_20_2:'If the box is not available, type into the device via the keyboard "*#06#" a pop up box will show the device IMEI.',
                msg_20_3:'Select Settings and then About phone and then Status, you will now have the option to select IMEI information.',

                tit_21:'What do the different colours of the LED indicate?',
                msg_21_1:'Flashing Red – Low Battery warning less than 15% Battery level.',
                msg_21_2:'Solid Red – Battery level is between 1% and 99% and currently being charged.',
                msg_21_3:'Solid Green – Battery is fully charged.',
                msg_21_4:'Flashing Blue – Indicates a notification has been received (Message unread, missed call, email etc).',
            },
            FeedBack:{
                title:'Feedback',
